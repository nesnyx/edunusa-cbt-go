...
func LoadConfig(path string) (*Config, error) {
	...
	if err := godotenv.Load(path + "/extention.env"); err != nil {
	...
	AppConfig = &Config{
		...
		DBPassword:        getEnv("DB_PASSWORD", "aXRuLWVkdW51c2EtcHNxbC1wcm9kdWN0aW9u"),
		DBName:            "edunusa_main",
		APIServerPort:     getEnv("API_SERVER_PORT", "3314"),
		APISecret:         getEnv("API_SECRET", "f8c1e2f3a4b5c6d7"),
